...
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
namebot = redis:get(bot_id..":namebot") or "كريزي"
SudosS = {1752994831,1006746356}
Sudos = {sudoid,1752994831,1006746356}
----------------------------------------------------------------------------------------------------
----------------------------------------------------------------------------------------------------
function Bot(msg)  
local idbot = false  
...
type = 'inline',
data = {
{{text = '‹ 𝙎𝙤𝙪𝙧𝙘𝙚 𝙆𝙧𝙞𝙕𝙚 ›',url="t.me/rq_ok"}},
}
}
...
{{text = "'الموقع'" ,data="GetSe_"..user_id.."_messageLocation"},{text = GetSetieng(chat_id).messageLocation ,data="GetSe_"..user_id.."_messageLocation"}},
{{text = "'التكرار'" ,data="GetSe_"..user_id.."_flood"},{text = GetSetieng(chat_id).flood ,data="GetSe_"..user_id.."_flood"}},
{{text = "'‹ ↫ ›'" ,data="GetSeBk_"..user_id.."_0"},{text = "'➡️'" ,data="GetSeBk_"..user_id.."_2"}},
}
}
...
{{text = ' ▹￤ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "كريزي"),data="delnamebot"}},
...
os.execute('curl -s https://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@raw.githubusercontent.com/mafia132/OPOP/main/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
{{text = ' ▹￤ جلب نسخة احتياطية',data="GetfJson"},{text = ' ▹￤ رفع نسخة احتياطية',data="UpfJson"}},
                {{text = ' ▹￤ تحديث',data="UpBot"},{text = ' ▹￤ تحديث السورس',data="UpSu"}},
{{text = '❲ Source MAS ❳',url="t.me/S_T_Dl"}},
}
}
bot.sendText(msg.chat_id,msg.id,"*  ▹￤اهلا بك في قائمة الاوامر : العللامة ( ✅ ) تعني الامر مفعل و ( ❌ ) العكس*","md", true, false, false, false, reply_dev)
end
...
os.execute('rm -rf start.lua')
os.execute('curl -s https://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@raw.githubusercontent.com/mafia132/OPOP/main/start.lua -o start.lua')
dofile('start.lua')  
end
end
if text == "تحديث" then
...
reply_markup = bot.replyMarkup{
type = 'inline',data = {
{{text = "• اوامࢪ الحماية •" ,data="Amr_"..msg.sender.user_id.."_1"},{text = "• إعدادات المجموعة •",data="Amr_"..msg.sender.user_id.."_2"}},
...
{{text = "'‹ ↫ ›'" ,data="GetSeBk_"..msg.sender.user_id.."_1"}},
}
}
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/rq_ok&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعة" then
bot.sendText(msg.chat_id,msg.id,"*  ▹￤الساعة الان : ( "..os.date("%I:%M%p").." )*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "ماس"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "كريزي"),"اني لقميل "..(redis:get(bot_id..":namebot") or "ماس"),(redis:get(bot_id..":namebot") or "ماس").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "ماس") then
...
local UserId_Info = bot.searchPublicChat("M_X_FF")
if UserId_Info.id then
...
local Text = "*𝘞𝘦𝘭𝘤𝘰𝘮 𝘵𝘰 𝘚𝘰𝘶𝘳𝘤𝘦 𝘒𝘳𝘪𝘡𝘦\n\n*[ ▹￤  قناة السورس](http://t.me/rq_ok)*\n\n*[ ▹￤  شروحات السورس](http://t.me/rq_oM)*\n\n*[ ▹￤  مطور السورس](http://t.me/M_X_FF)*\n\n*[ ▹￤  مبرمج السورس](http://t.me/kr_7d)*\n*"
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '‹ 𝙎𝙤𝙪𝙧𝙘𝙚 𝙆𝙧𝙞𝙕𝙚 ›',url="t.me/rq_ok"}
