...
{{text = ' ▹￤ تغيير اسم البوت',data="namebot"},{text =(redis:get(bot_id..":namebot") or "ماس"),data="delnamebot"}},
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/S_T_Dl&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعة" then
bot.sendText(msg.chat_id,msg.id,"*  ▹￤الساعة الان : ( "..os.date("%I:%M%p").." )*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"اسمي "..(redis:get(bot_id..":namebot") or "ماس"),"عمريي اسمي "..(redis:get(bot_id..":namebot") or "ماس"),"اني لقميل "..(redis:get(bot_id..":namebot") or "ماس"),(redis:get(bot_id..":namebot") or "ماس").." اني"}
